...
<spring:url var="vendorBootstrapJs" value="/resources/vendor/bootstrap/js"/>
...
<html lang="en">
  ...
  <body>
    ...
    <script src="${vendorJquery}/jquery/jquery.slim.min.js"></script>
    <script src="${vendorBootstrapJs}/bootstrap/js/bootstrap.bundle.min.js"></script>
